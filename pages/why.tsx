...
export default function Why() {
    ...
    return (
        <Main opaque>
            ...
            <h2 className="text-5xl text-gt-violet font-bold">{pageTitle}</h2>
            <CloseButton />
            <Spacer />
