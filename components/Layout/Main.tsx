...
export const Main: React.FC<{ opaque?: boolean, showLogo?: boolean }> = ({ children, opaque = false, showLogo = true }) => {
    return (
        <div className="grid grid-cols-1 md:h-gt-main">
            ...
            <div className={cx("col-start-1 col-end-1 row-start-1 row-end-1 z-10 relative md:h-full md:overflow-y-scroll", { "bg-gt-main-opaque": opaque })}>
